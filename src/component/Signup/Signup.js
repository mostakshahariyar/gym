                                ...
                                <div className='flex flex-col justify-center p-8 md:p-14'>
                                        ...
                                        <dir className="p-0 flex flex-col gap-5">
                                                <div className='flex items-center rounded-lg border-2 border-gray-200 p-3'>
                                                        ...
                                                        <input type="text" placeholder='Enter your name' className='border-none outline-none' />
                                                </div>
                                                <div className='flex items-center rounded-lg border-2 border-gray-200 p-3'>
                                                ...
                                                <div className='flex items-center rounded-lg border-2 border-gray-200 p-3'>
                                                        ...
                                                        <input type="text" placeholder='Enter your Password' className='border-none outline-none' />
                                                </div>
                                        ...
                                        <div className="text-center text-gray-400">
                                                Have an account?
                                                <Link to="/login" className="font-bold text-black cursor-pointer"> Sign in for free</Link>
                                        </div>
                                </div>
                                {/* right side */}
